...
\begin{table*}[ht]\centering
  ...
  \begin{tabularx}{\textwidth}{@{}rXl@{}}\toprule
    ...
    1 & CreateDocumentOffline & High   \\\hline
    2 & SynchronizeChanges   & High   \\\hline
    3 & MultipleUserEdit     & High   \\\hline
    4 & ViewVersionHistory   & Medium \\\hline
    5 & CreateDocumentOnline & High \\\hline
    6 & EditDocumentOnline	 & High \\
    \bottomrule
  \end{tabularx}
...
\newline
\textbf{Precondition:} The file list is not empty and the user have a running internet connection.
\newpage